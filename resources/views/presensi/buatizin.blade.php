...
<div class="appHeader text-light" style="background-color: #008DDA;">
        ...
        <div class="pageTitle">Leave and Sick Application Form</div>
        <div class="right"></div>
    </div>
<!-- App Header -->
@endsection
...
<form method="POST" action="/presensi/storeizin" id="frmIzin" name="frmIzin">
    ...
    <div class="form-group" style="margin-top: 10px;">
        <select name="status" id="status" class="form-control">
            ...
            <option value="i">Paid Leave</option>
    ...
    <div class="form-group">
        <textarea name="keterangan" id="keterangan" cols="30" rows="5" placeholder="Information" class="w-100"></textarea>
    </div>
