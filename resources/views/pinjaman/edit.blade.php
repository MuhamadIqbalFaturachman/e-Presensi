...
<div class="appHeader text-light" style="background-color: #008DDA;">
    ...
    <div class="pageTitle">Edit Loan</div>
    <div class="right"></div>
</div>
<!-- App Header -->
@endsection
...
@section('content')<div class="container" style="margin-top: 70px; margin-bottom: 70px;" >
    <h2 style = "text-align: center;">Menu for Edit Employee Loan Data</h2>
    <form action="{{ route('pinjaman.update', $pinjaman->id) }}" method="POST">
        @csrf
        <div class="form-group">
            <label for="id_pinjaman">Loan Id</label>
            <input type="text" class="form-control" id="id_pinjaman" name="id_pinjaman" value="{{$pinjaman->id_pinjaman}}">
        </div>
        <div class="form-group">
            <label for="nama_peminjam">Employee</label>
            <input type="text" class="form-control" id="nama_peminjam" name="nama_peminjam" value="{{$pinjaman->nama_peminjam}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="metode" name="metode" value="{{$pinjaman->metode}}">
        </div>
        <div class="form-group">
            <label for="angrusan">Installments</label>
            <input type="text" class="form-control" id="angsuran" name="angsuran" value="{{$pinjaman->angsuran}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="time" class="form-control" id="waktu_pinjaman" name="waktu_pinjaman" value="{{$pinjaman->waktu_pinjaman}}">
        </div>
